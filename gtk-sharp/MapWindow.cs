...
namespace Weland
{
    ...
    public partial class MapWindow
    {
        ...
        public MapWindow(string title)
        {
            ...
            Glade.XML gxml = new Glade.XML(null, "weland.glade.mapwindow.glade", "window1", null);
        ...
        {
            FileChooserDialog d = new FileChooserDialog("Export script as", window1, FileChooserAction.Save, "Cancel", ResponseType.Cancel, "Save", ResponseType.Accept);
            d.SetCurrentFolder(Weland.Settings.GetSetting("LastSave/Folder", Environment.GetFolderPath(Environment.SpecialFolder.Personal)));
        ...
        internal void OnGridOriginSet(object o, EventArgs e)
        {
            if (!editor.SetCustomGridOriginToSelected())
            {
                ...
                PointDialog dialog = new PointDialog(window1);
                dialog.Value = p;
                dialog.Run();
