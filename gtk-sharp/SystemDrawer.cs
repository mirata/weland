...
public class SystemDrawer : Drawer
{
    class TextureCache : IDisposable
    {
        ...
        Dictionary<ushort, System.Drawing.Bitmap> cache = [];
    }
    ...
    {
        return System.Drawing.Color.FromArgb((byte)(c.A * 255), (byte)(c.R * 255), (byte)(c.G * 255), (byte)(c.B * 255));
    }
    ...
    {
        var pointArray = new System.Drawing.PointF[points.Count];
    ...
    public override void FillStrokePolygon(Color fill, Color stroke, List<Point> points, bool dashed)
    {
        ...
        var pen = new Pen(SystemColor(stroke));
        if (dashed)
        {
